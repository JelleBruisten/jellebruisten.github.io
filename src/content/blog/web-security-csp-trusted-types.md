...
Trusted Types do. They are a browser API, supported across all major browsers since February 2026, that restricts what values can be assigned to dangerous DOM sinks.
